...
public:
    ...
    void die()
    {
        //changes the color of the shooter red and green alternately
        for(int c=0 ; c<100 ; c++){
            head.setColor(COLOR(255,50,0));
            body.setColor(COLOR(255,50,0));
            wait(0.6);
    ...
    void hit()
    {
        //changes the color of the shooter to blue when hit
        head.setColor(COLOR(0,0,255));
